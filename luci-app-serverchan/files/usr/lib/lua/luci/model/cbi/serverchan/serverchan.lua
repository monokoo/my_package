...
e=t:option(ListValue,"t_client",translate("设备上线时"))
e.default="disable"
e:value("disable",translate("不发送"))
e:value("all",translate("发送"))
e:value("nomac",translate("发送(不包含MAC地址)"))

e=t:option(ListValue,"t_client_filter",translate("黑白名单（设备上线）"))
e.default="disable"
e:value("disable",translate("关闭"))
e:value("blacklist",translate("黑名单"))
e:value("whitelist",translate("白名单"))
e:depends("t_client","all")
e:depends("t_client","nomac")

e=t:option(DynamicList,"t_client_blacklist",translate("黑名单（设备上线）"))
e.datatype="macaddr"
e.optional=false
m.net.mac_hints(function(m,a)
e:value(m,"%s (%s)"%{m,a})                                                                                                                    
end)
e:depends("t_client_filter","blacklist")
e=t:option(DynamicList,"t_client_whitelist",translate("白名单（设备上线）"))
e.datatype="macaddr"
e.optional=false
m.net.mac_hints(function(m,a)
e:value(m,"%s (%s)"%{m,a})                                                                                                                    
end)
e:depends("t_client_filter","whitelist")
return a
