...
var YAAW = (function() {
  ...
  return {
    ...
    event_init: function() {
	  ...
	  $("ul.tasks-list li a").live("click", function() {
		  var selnum = $(this).parent().index();
		  $("#MainBody section").hide();
		  $("#MainBody section").eq(selnum).show();
		  $("ul.tasks-list li").removeClass("active");
      ...
      $("#ib-file-save").live("click", function() {
        ...
        if (indexes.length == 0) {
          ARIA2.main_alert("alert-error", "文件已被选择或则任务已经停止.", 5000);
        } else {
          var options = {
